...
/*   User avatar information endpoint*/
...
describe("Websocket tests", () => {
    ...
    let adminX;
    let adminY;
//https://chatgpt.com/c/6739b07f-6158-8003-ac0f-ffa6d4c0c477
    function waitForAndPopLatestMessage(messageArray) {
        return new Promise(resolve => {
            if (messageArray.length > 0) {
                resolve(messageArray.shift())
            } else {
                // repeatedly check (poll) the array at regular intervals until a new message arrives
    ...
    async function setupWs() {
       ...
       //Promise is used here to pause the execution of the code until the WebSocket connection has been successfully opened
        await new Promise(r => {
            ws1.onopen = r
          })
